...
describe("the rulings cover the derived population", () => {
  ...
  it("derives what survives with a row from the table's own columns", () => {
    ...
    expect(
      ...
      "finance_manual_payment_proof_attempts: original_file_name, r2_key, verdict_reason",
      "finance_manual_payment_proofs: original_file_name, r2_key, rejection_reason",
      "finance_payment_events: metadata, reason",
      "finance_payment_instruction_snapshots: account_holder_name, account_number, bank_name, instructions_note, qris_r2_key",
      "institution_audit_logs: metadata",
      "institution_invitations: invited_email",
      "institution_payment_instructions: account_holder_name, account_number, bank_name, instructions_note, qris_r2_key",
      "institution_social_links: url",
      "institution_verification_audit: reason",
      "institution_verification_documents: content_type, document_type, original_file_name, r2_key",
      "institution_verification_submissions: proposed_display_name, reviewer_notes",
      "institutions: about, banner_r2_key, contact_email, contact_name, contact_phone, description, display_name, logo_r2_key, rejection_reason, slug, suspension_reason, website_url",
