...
export const PAGES = [
  ...
  { id: "03-competitions-filtered", as: null, path: "/competitions?category=hackathon&sort=deadline_asc", label: "Listing with category filter + sort" },
  { id: "04-competitions-all-status", as: null, path: "/competitions?status=all", label: "Listing including finished competitions" },
  { id: "05-competitions-search", as: null, path: "/competitions?q=hackathon", label: "Listing with search query" },
  { id: "06-detail-open", as: null, path: "/competitions/seed-academy/seed-open", label: "Detail — registration open (prizes, rounds, tags)" },
  { id: "07-detail-upcoming", as: null, path: "/competitions/seed-academy/seed-upcoming", label: "Detail — not yet open (CTA disabled)" },
  { id: "08-detail-closing", as: null, path: "/competitions/seed-academy/seed-closing", label: "Detail — closing soon badge" },
  { id: "09-detail-closed", as: null, path: "/competitions/seed-academy/seed-closed", label: "Detail — registration closed" },
  { id: "10-detail-inprogress", as: null, path: "/competitions/seed-academy/seed-inprogress", label: "Detail — event in progress" },
  { id: "11-detail-awaiting", as: null, path: "/competitions/seed-academy/seed-awaiting", label: "Detail — awaiting results" },
  { id: "12-detail-overdue", as: null, path: "/competitions/seed-academy/seed-overdue", label: "Detail — results overdue" },
  { id: "13-detail-done", as: null, path: "/competitions/seed-academy/seed-done", label: "Detail — results announced (archive stays public)" },
  { id: "14-detail-personal-org", as: null, path: "/competitions/seed-rec-min/seed-personal-open", label: "Detail — personal institution organizer (derived identity)" },
  { id: "15-institution-public", as: null, path: "/institution/seed-academy", label: "Public institution page (signed out)" },
  ...
  { id: "18-auth-login-as-recruiter", as: null, path: "/auth/login?as=recruiter", label: "Auth entry with role hint" },
  { id: "19-auth-register-redirect", as: null, path: "/auth/register", label: "/auth/register → login redirect" },
  { id: "20-auth-verify-request", as: null, path: "/auth/verify-request", label: "Verification email sent notice" },
  { id: "21-auth-activated", as: null, path: "/auth/activated", label: "Account activated notice" },
  { id: "22-auth-verify-email-bad", as: null, path: "/auth/verify-email?token=invalid-seed-token", label: "Email verification — invalid token state" },
  { id: "23-suspended", as: null, path: "/suspended", label: "Suspended account notice" },
  { id: "24-protected-anon", as: null, path: "/protected", label: "Protected route while signed out" },
  { id: "25-registration-anon", as: null, path: "/competitions/seed-academy/seed-open/registration", label: "Registration subpage while signed out" },
  { id: "26-detail-404", as: null, path: "/competitions/seed-academy/tidak-ada-slug", label: "Competition 404" },
  { id: "27-dev-primitives", as: null, path: "/dev/primitives", label: "UI primitives dev surface" },
  ...
  { id: "37-inbox", as: "candA", path: "/inbox", label: "Notification inbox (notifs + pending invite)" },
  ...
  { id: "47-candidate-on-institution", as: "candA", path: "/institution/seed-academy/competitions", label: "Candidate hitting an institution surface (guard)" },
  { id: "48-registration-team-captain", as: "candC", path: "/competitions/seed-academy/seed-upcoming/registration", label: "Registration subpage — forming team as captain" },
  ...
  { id: "65-institution-verification-pending", as: "recElev", path: "/institution/seed-ventures/verification", label: "Institution verification — pending panel" },
  { id: "66-institution-audit-log", as: "recElev", path: "/institution/seed-academy/audit-log", label: "Institution audit log" },
  { id: "67-institution-create", as: "recElev", path: "/institution/create", label: "Create full institution" },
  { id: "68-institution-personal-create", as: "recElev", path: "/institution/personal", label: "Create personal institution" },
  { id: "69-institution-board-pending", as: "recElev", path: "/institution/seed-ventures", label: "Institution board — pending verification" },
  { id: "70-institution-board-suspended", as: "recElev", path: "/institution/seed-suspended-org", label: "Institution board — suspended institution" },
  { id: "71-recruiter-dashboard-min", as: "recMin", path: "/recruiter-dashboard", label: "Recruiter dashboard — minimal tier, pending review" },
  { id: "72-personal-institution-board", as: "recMin", path: "/institution/seed-rec-min", label: "Personal institution board" },
  { id: "73-personal-upgrade", as: "recMin", path: "/institution/seed-rec-min/verification", label: "Personal institution upgrade surface" },
  { id: "74-personal-settings", as: "recMin", path: "/institution/seed-rec-min/settings", label: "Personal institution settings (name/slug locked)" },
  { id: "75-recruiter-dashboard-rejected", as: "recRej", path: "/recruiter-dashboard", label: "Recruiter dashboard — verification rejected + reason" },
  { id: "76-recruiter-dashboard-draft", as: "recDraft", path: "/recruiter-dashboard", label: "Recruiter dashboard — withdrawn draft warning" },
  { id: "77-inbox-recruiter-invite", as: "recRej", path: "/inbox", label: "Inbox with a pending institution invitation" },
  { id: "78-dual-dashboard", as: "dual", path: "/candidate-dashboard", label: "Dual-role account on the candidate side" },
  { id: "79-dual-recruiter", as: "dual", path: "/recruiter-dashboard", label: "Dual-role account on the recruiter side" },

  // ---------------------------------------------------------------- platform ops
  { id: "80-admin-hub", as: "ops", path: "/admin", label: "Platform ops hub" },
  { id: "81-admin-institutions", as: "ops", path: "/admin/institutions", label: "Institution verification table" },
  { id: "82-admin-moderation", as: "ops", path: "/admin/moderation", label: "Moderation & lookup console" },
  { id: "83-admin-moderation-user", as: "ops", path: "/admin/moderation?email=seed.cand.a@seed.lombakita.local", label: "Moderation — user lookup result" },
