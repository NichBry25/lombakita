 ...
 * vocabulary of `.eligibility-status-card` and `.team-eligibility`, different components with the
 * same attribute name, and a `.status-badge` carrying either is unstyled.
 *
